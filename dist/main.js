...
(function () {
    ...
    function instance($$self, $$props, $$invalidate) {
    	let { greeting = "Hello World!" } = $$props;

    	$$self.$set = $$props => {
    		if ('greeting' in $$props) $$invalidate('greeting', greeting = $$props.greeting);
    	};
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, ["greeting"]);
    	}
